...
const { ARENA_HEIGHT, ARENA_WIDTH, TANK_SIZE: TILE } = require('../constants');
function rect(gx, gy, gw = 1, gh = 1) {
  return { x: gx * TILE, y: gy * TILE, w: gw * TILE, h: gh * TILE };
}

module.exports = {
  id: 'map2',
  name: 'River Crossing (styled)',
  w: ARENA_WIDTH,
  h: ARENA_HEIGHT,
  // outer bounds
  walls: [
  ...
  rivers: [
    rect(4, 4, 6, 2),
    rect(14, 4, 6, 2), // top horizontal rivers
